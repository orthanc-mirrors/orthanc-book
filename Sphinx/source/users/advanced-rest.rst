...
1.12.6, this value is ``1`` by default.
...
* ``Retry``: The job has failed internally, and has been scheduled for
  re-submission after a delay. As of Orthanc 1.12.6, this feature is not
...
<https://orthanc.uclouvain.be/hg/orthanc-tests/file/Orthanc-1.12.6/Tests/Toolbox.py>`__
...
<https://orthanc.uclouvain.be/hg/orthanc/file/Orthanc-1.12.6/OrthancServer/Sources/ServerJobs/ArchiveJob.cpp>`__
of Orthanc).
...
As of Orthanc 1.12.6, only the creation of a ZIP or a DICOMDIR archive
