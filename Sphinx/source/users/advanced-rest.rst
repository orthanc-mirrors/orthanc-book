...
1.13.0, this value is ``1`` by default.
...
* ``Retry``: The job has failed internally, and has been scheduled for
  re-submission after a delay. As of Orthanc 1.13.0, this feature is not
...
<https://orthanc.uclouvain.be/hg/orthanc/file/Orthanc-1.13.0/OrthancServer/Sources/ServerJobs/ArchiveJob.cpp>`__
of Orthanc).
...
As of Orthanc 1.13.0, only the creation of a ZIP or a DICOMDIR archive
