...
1.12.0, this value is ``1`` by default.
...
* ``Retry``: The job has failed internally, and has been scheduled for
  re-submission after a delay. As of Orthanc 1.12.0, this feature is not
...
<https://hg.orthanc-server.com/orthanc-tests/file/Orthanc-1.12.0/Tests/Toolbox.py>`__
...
<https://hg.orthanc-server.com/orthanc/file/Orthanc-1.12.0/OrthancServer/Sources/ServerJobs/ArchiveJob.cpp>`__
of Orthanc).
...
As of Orthanc 1.12.0, only the creation of a ZIP or a DICOMDIR archive
