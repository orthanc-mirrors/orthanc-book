...
1.12.1, this value is ``1`` by default.
...
* ``Retry``: The job has failed internally, and has been scheduled for
  re-submission after a delay. As of Orthanc 1.12.1, this feature is not
...
As of Orthanc 1.12.1, only the creation of a ZIP or a DICOMDIR archive
