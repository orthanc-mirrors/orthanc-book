...
1.12.11, this value is ``1`` by default.
...
* ``Retry``: The job has failed internally, and has been scheduled for
  re-submission after a delay. As of Orthanc 1.12.11, this feature is not
...
<https://orthanc.uclouvain.be/hg/orthanc-tests/file/Orthanc-1.12.11/Tests/Toolbox.py>`__
...
<https://orthanc.uclouvain.be/hg/orthanc/file/Orthanc-1.12.11/OrthancServer/Sources/ServerJobs/ArchiveJob.cpp>`__
of Orthanc).
...
As of Orthanc 1.12.11, only the creation of a ZIP or a DICOMDIR archive
...
+-------------------------------------------------------------+-----------------------------------------------------------------------------------+----------------------------------------------------------------------+
| ``orthanc_storage_cache_hit_count``                         | The number of time a file has been read from the Storage cache                    | Orthanc Storage cache                                                |
+-------------------------------------------------------------+-----------------------------------------------------------------------------------+----------------------------------------------------------------------+
| ``orthanc_storage_cache_miss_count ``                       | The number of time a file has been read from the Storage (it was not in the       | Orthanc Storage cache                                                |
|                                                             | Storage cache when Orthanc needed it)                                             |                                                                      |
+-------------------------------------------------------------+-----------------------------------------------------------------------------------+----------------------------------------------------------------------+
