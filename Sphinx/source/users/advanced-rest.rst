...
1.11.3, this value is ``1`` by default !
...
* ``Retry``: The job has failed internally, and has been scheduled for
  re-submission after a delay. As of Orthanc 1.11.3, this feature is not
...
<https://hg.orthanc-server.com/orthanc-tests/file/Orthanc-1.11.3/Tests/Toolbox.py>`__
...
<https://hg.orthanc-server.com/orthanc/file/Orthanc-1.11.3/OrthancServer/Sources/ServerJobs/ArchiveJob.cpp>`__
of Orthanc).
...
As of Orthanc 1.11.3, only the creation of a ZIP or a DICOMDIR archive
