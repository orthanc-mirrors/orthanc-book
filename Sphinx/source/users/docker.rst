...
Orthanc to be run::
  ...
  $ sudo docker run -p 4242:4242 -p 8042:8042 --rm jodogne/orthanc:1.5.4
...
container to some path in the filesystem of your Linux host, e.g.::
  ...
  $ sudo docker run -p 4242:4242 -p 8042:8042 --rm -v /tmp/orthanc-db/:/var/lib/orthanc/db/ jodogne/orthanc:1.5.4 
...
* This command launches the mainline version. To start a released version,
  use e.g. ``jodogne/orthanc-debug:1.5.4``.
