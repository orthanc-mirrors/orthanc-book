...
<https://orthanc.uclouvain.be/hg/orthanc/file/Orthanc-1.13.0/OrthancServer/Plugins/Include/orthanc/OrthancCPlugin.h>`__
...
Note however, that, as of Orthanc 1.13.0, the Orthanc plugin SDK
...
* The call to ``orthanc.ExtendOrthancExplorer()`` installs the button
  ...
  <https://demos.jquerymobile.com/1.1.0/>`__ (as of Orthanc 1.13.0,
