...
`PrepareDatabase.sql
<https://hg.orthanc-server.com/orthanc/file/Orthanc-1.7.1/OrthancServer/Database/PrepareDatabase.sql>`__
and `InstallTrackAttachmentsSize.sql
<https://hg.orthanc-server.com/orthanc/file/Orthanc-1.7.1/OrthancServer/Database/InstallTrackAttachmentsSize.sql>`__.
