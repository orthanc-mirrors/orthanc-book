...
`PrepareDatabase.sql
<https://hg.orthanc-server.com/orthanc/file/Orthanc-1.7.0/OrthancServer/Database/PrepareDatabase.sql>`__
and `InstallTrackAttachmentsSize.sql
<https://hg.orthanc-server.com/orthanc/file/Orthanc-1.7.0/OrthancServer/Database/InstallTrackAttachmentsSize.sql>`__.
