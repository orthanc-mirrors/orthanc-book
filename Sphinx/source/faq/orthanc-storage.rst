...
`PrepareDatabase.sql
<https://hg.orthanc-server.com/orthanc/file/Orthanc-1.11.3/OrthancServer/Sources/Database/PrepareDatabase.sql>`__
and `InstallTrackAttachmentsSize.sql
<https://hg.orthanc-server.com/orthanc/file/Orthanc-1.11.3/OrthancServer/Sources/Database/InstallTrackAttachmentsSize.sql>`__.
