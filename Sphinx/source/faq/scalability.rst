...
* Make sure to use the latest release of Orthanc (1.7.1 at the time of
  writing).
...
As of Orthanc 1.7.1, the internal code accessing the DB is still affected
...
to the database.  As a consequence, as of Orthanc 1.7.1, when connecting multiple
...
As of Orthanc 1.7.1, Orthanc still performs quite a large number of small
